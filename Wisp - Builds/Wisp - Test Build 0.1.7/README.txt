Project Wisp - Combat Prototype Ver. 0.1.7
Developed by Nathan Warren-Acord

0.1.6 Changes --
Time-stop is now indicated by the background fading to grayscale - actors, items, GUI, etc. are not affected

0.1.7 Changes --
Player melee damage increased from 1 to 2
Wisp health increased from 2 to 3
Phantom health increased from 4 to 5
Voidseer health increased from 5 to 6
Player now has damage animation - the same red flicker that enemies already had
